...
appList += '<li data-app="78"><a href="http://goo.gl/uAj2cA">나의 연관검색어</a></li>';
appList += '<li data-app="77"><a href="http://goo.gl/pxiUqd">함께 휴가가는 연예인</a> <span class="ico hot"></span></li>';
appList += '<li data-app="76"><a href="http://goo.gl/GOIAaR">나는 언제까지 솔로인가?</a> <span class="ico hot"></span></li>';
appList += '<li data-app="75"><a href="http://goo.gl/5yqyOY">개구쟁이 스머프</a></li>';
//appList += '<li data-app="74"><a href="http://goo.gl/hJpgvO"><b style="color:red">[긴급보안 공유] 무한공유 해주세요.</b></a></li>';
