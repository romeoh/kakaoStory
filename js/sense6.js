...
database = [
	...
	{'obj': '자기의 가치에대해 자랑하고 다닌다.♥'},
	{'obj': '거짓말을 입에 달고산다.♥'},
	{'obj': '속임수를 경명하거나 극단적으로 싫어한다.♥'},
	{'obj': '범죄를 저질러도 양심에 가책을 느끼지않는다.♥'},
	{'obj': '감동적인걸봐도 감동인지 모른다.♥'},
	{'obj': '매사에 냉담하고 남이 말하는 것에 공감하지 않는다.♥'},
	{'obj': '책임감이 없거나 부족하다.♥'},
	{'obj': '일상생활에 정신적 자극이 필요하고 지루함이 많다.♥'},
	{'obj': '기생충처럼 남에게 빌붙어산다.♥'},
	{'obj': '나쁜행동을 자제할 능력이 부족하다.♥'},
	{'obj': '소년비행을 경험하거나 영유아기때 잔인한 짓을 많이 했다.♥'},
	{'obj': '현실성이 부족한 목표를 길게 끌며 그것을 할수있다고 믿는다.♥'},
	{'obj': '매사에 충동적이다.♥'},
	{'obj': '무책임하다.♥'},
	{'obj': '소년비행을 해본적있다.♥'},
	{'obj': '약속을 잘 깬다.♥'},
	{'obj': '아무대서나 성적인 행동을 서슴치 않는다.♥'},
	{'obj': '많고 짧은 연애를 한다.♥'},
	{'obj': '범재적 재능을 타고 낫거나 재능을 이용하라고 한다.♥'}
]
